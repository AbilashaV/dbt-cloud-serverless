...
select
    id as ride_id,
    assign_time::datetime as assign_time_utc,
    cancel_reason,
    cancel_reason_type,
    car_type,
    city,
    company_id,
    coupon_code,
    create_time::datetime as create_time_utc,
    credit_card_id,
    currency,
    discount,
    driver_application_fee,
    driver_info,
    drop_off_time::datetime as drop_off_time_utc,
    estimated_price,
    etc_fee,
    pay_status,
    payment_method,
    pick_up_arrived_time::datetime as pick_up_arrived_time_utc,
    -- pick_up_distance_km,
    trunc(pick_up_distance_km, 2) as pick_up_distance_km,
    pick_up_start_time::datetime as pick_up_start_time_utc,
    pick_up_zone_id,
    refund_amount,
    region,
    -- ride_distance_km,
    ...
    rider_uuid,
    sd,
    start_time::datetime as start_time_utc,
    toll_fee,
    way_point,
    fraud,
    destination_zone_id,
    ...
    reservation_ride_start_time::datetime as reservation_ride_start_time_utc,
    reservation_fee,
    driver_penalty_fee,
    ...
    confirm_time::datetime as confirm_time_utc,
    payment_item_uuid,
    mdd,
